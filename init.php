...
{	
	...
	{
		return array(
			'CP_DIRECTORY'						=> 'MeQ0prXz8WdH0Jc3R6AHxjWAYAPEtRUl',
			'IN_DEV'							=> FALSE,
			'DEV_USE_WHOOPS'					=> TRUE,
			...
			'SUITE_UNIQUE_KEY'					=> mb_substr( md5( 'NULL' . '$Rev: 3023$'), 10, 10 ),
			'CACHEBUST_KEY'						=> mb_substr( md5( 'NULL' . '$Rev: 3023$'), 10, 10 ), // This looks unnecessary but SUITE_UNIQUE_KEY can be set to a constant constant in constants.php whereas we need a version specific constant for cache busting.
