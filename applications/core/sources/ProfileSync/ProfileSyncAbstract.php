...
{	
	...
	public function sync()
	{
		...
		/* We check against canImportStatus() to ensure we check all appropriate restrictions, including group and member restrictions */
		if ( $settings['status'] and $settings['status'] == 'import' and $this->canImportStatus( $this->member ) )
		{
