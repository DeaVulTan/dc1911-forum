...
class _ajax extends \IPS\Dispatcher\Controller
{
    ...
    public function topAwarded()
    {
        ...
        {
            //$topAwarded = iterator_to_array( \IPS\Db::i()->select( 'awarded_member as member, awarded_id as awarded', 'awards_awarded', array(  ), 'awarded DESC', $limit )->setKeyField('member')->setValueField('awarded') );
