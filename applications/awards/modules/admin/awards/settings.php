...
class _settings extends \IPS\Dispatcher\Controller
{
    ...
    protected function manage()
    {
        ...
        $form->add( new \IPS\Helpers\Form\Node( 'award_settings_pane_cat', $this->id ? $this->id : explode( ',', \IPS\Settings::i()->award_settings_pane_cat ), FALSE, array(
        ...
        $form->add( new \IPS\Helpers\Form\Node( 'award_settings_posts_cat', $this->id ? $this->id : explode( ',', \IPS\Settings::i()->award_settings_posts_cat ), FALSE, array(
            'class'         => 'IPS\awards\Cats',
            'multiple'      => TRUE,
            'subnodes'      => FALSE,
            'noParentNodes' => 'Custom'
        ...
        $form->add( new \IPS\Helpers\Form\Node( 'award_settings_hover_cat', $this->id ? $this->id : explode( ',', \IPS\Settings::i()->award_settings_pane_cat ), FALSE, array(
            'class'         => 'IPS\awards\Cats',
            'multiple'      => TRUE,
            'subnodes'      => FALSE,
            'noParentNodes' => 'Custom'
