 ...
 * awards_system
 */
class _awards_system extends \IPS\Dispatcher\Controller
{
    /**
     * Execute
     * @return    void
            ...
            } else
            {
                ...
                if ( $values = $form->values() )
                {
                    ...
                    if ( $values['awards_as_upgrade'] == 1 )
                    {
                        ...
                        \IPS\Output::i()->redirect( \IPS\Http\Url::internal( 'app=awards&module=upgrade&controller=awards_system' ), 'awards_as_upgraded_msg' );
