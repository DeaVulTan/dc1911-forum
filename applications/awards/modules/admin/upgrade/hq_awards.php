 ...
 * hq_awards
 */
class _hq_awards extends \IPS\Dispatcher\Controller
{
            ...
            } else
            {
                ...
                if ( $values = $form->values() )
                {
                    if ( $values['awards_hq_upgrade'] == 1 )
                    {
                        ...
                        \IPS\Output::i()->redirect( \IPS\Http\Url::internal( 'app=awards&module=upgrade&controller=hq_awards' ), 'awards_hq_upgraded_msg' );
