...
class _Awards extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
    ...
    {
        return \IPS\Http\Url::internal( "app=awards", 'front', 'awards' );
    }
    ...
    {
        return \IPS\Dispatcher::i()->application->directory === 'awards' and \IPS\Dispatcher::i()->module and \IPS\Dispatcher::i()->module->key === 'awards' and \IPS\Dispatcher::i()->controller == 'awards';
    }
