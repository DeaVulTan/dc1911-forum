...
$form->add( new \IPS\Helpers\Form\Select( 'cloak_groups', \IPS\Settings::i()->cloak_groups == '*' ? '*' : explode( ',', \IPS\Settings::i()->cloak_groups ), FALSE, array( 'options' => \IPS\Member\Group::groups(), 'parse' => 'normal', 'multiple' => TRUE, 'unlimited' => '*', 'unlimitedLang' => 'Все группы' ) ) );
...
$form->add( new \IPS\Helpers\Form\Select( 'cloak_message_type', isset( \IPS\Settings::i()->cloak_message_type ) ? \IPS\Settings::i()->cloak_message_type : array(), FALSE, array( 'options' => [ 'inline' => 'В строке', 'box' => 'Окно сообщения', 'invisible' => 'Невидимый', 'custom' => 'Пользовательский' ], 'toggles' => [ 'custom' => [ 'cloak_guest_message', 'cloak_user_message' ] ] ), NULL, NULL, NULL, 'cloak_message_type' ) );
