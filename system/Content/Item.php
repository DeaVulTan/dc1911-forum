...
abstract class _Item extends \IPS\Content
{
	...
	public function firstComment()
	{
		...
		if( !$comment )
		{
			...
			{
				$idColumn	= static::$databaseColumnId;
				$comment	= $commentClass::constructFromData( \IPS\Db::i()->select( '*', $commentClass::$databaseTable, array( $commentClass::$databaseColumnMap['item'] . '=?', $this->$idColumn ), $commentClass::$databaseColumnMap['date'] . ' ASC', 1 )->first() );
